    ...
    def initialize_cluster_helps(include_target)
      ...
      @HELPS = {
        "communication" => _(
          ...
          "<p><b><big>name</big></b><br>Used mainly with knet transport to identify local node. It's also used by client software (pacemaker). Refer to man page(corosync.conf) for detail algorithm of local node name.<br></p>\n" +
          ...
          "<p><b><big>IP (ringX_addr)</big></b><br>This specifies IP or network hostname address of the particular node. X is a link number. Unicast and Multicast only support 1 link. Kronosnet support up to 8 links.<br></p>\n" +
          ...
          "<p><b><big>Link Number</big></b><br>The link number for the interface. When using the knet protocol, each interface should specify separate link numbers to uniquely identify to the membership protocol which interface to use for which link. <br>The linknumber must start at 0. <br>For UDP the only supported linknumber is 0.<br></p>\n" +
          ...
          "<p><b><big>Bind Network Address</big></b><br>UDP only.<br>This  specifies  the  address which the openais executive should bind.  This address should always end in zero. If the totem traffic should be routed over 192.168.5.92, set bindnetaddr to 192.168.5.0.<br>This may also be an IPV6 address, in which case IPV6 networking will be used. In this case, the full address must be specified and there is no automatic selection of the network interface within a specific subnet as with IPv4. If IPv6 networking is used, the nodeid field must be specified.<br></p>\n" +
          "<p><b><big>Multicast Address</big></b><br>UDP only.<br>This is the multicast address used by openais executive. The default  should work for most networks, but the network administrator should be queried about a multicast address to use. Avoid 224.x.x.x because this is a \"config\" multicast address.<br>This may also be an IPV6 multicast address, in which case IPV6 networking will be used.  If IPv6 networking is used, the nodeid field must be specified.</p>\n" +
          "<p><b><big>Multicast Port</big></b><br>UDP only.<br>This specifies the UDP port number. It is possible to use the same multicast address on a network with the openais services configured for different UDP ports.<br></p>\n" +
